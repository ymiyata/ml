function [x fval flag output net train_set test_set] = nn_usingrhc(n_neuron)
    load glass_dataset
    ...
    ps_opts = psoptimset('TolFun', 1e-5, 'MaxIter', 10000); %, 'PlotFcns', {@psplotbestf, @psplotbestx});
    ...
    [x, fval, flag, output] = patternsearch(fun, starting_values, [], [], ...
                        [], [], lb, ub, ps_opts);
end
